...
第二天，狐狸可能在洞口3或者5
            ...
            假如狐狸在洞口5，我们检查的是2，抓不到
                                                ...
                                                第四天，狐狸可能在3或者5，而我们检查的是3，所以，狐狸在3时就抓住了；这里设狐狸在5
                                                 第五天，狐狸只能在 4，我们检查的是4，抓到！
5.
...
阅读(42)┊ 评论 (0)┊	收藏(0) ┊转载(0)	┊ 喜欢▼ ┊打印┊举报
已投稿到：	排行榜 排行榜
前一篇：看完这21个故事,你就成了亿万富翁
后一篇：增进互信 深化合作 厚植友谊--记习近平美国之行
...
看完这21个故事,你就成了亿万富翁
后一篇 >
增进互信 深化合作 厚植友谊--记习近平美国之行



> A4纸的尺寸为什么是210*297毫米？

A4 里的 4 代表啥呢？4表示它是由A系列最大的纸张对折裁切4次而来的。A系列最大的纸张，就是A0纸。A1纸是A0纸的一半，A2纸是A1纸的一半，以此类推。

![](./img-game/2019-06-23-11-58-52.png)

那么，为什么 A0 纸是 841*1189 毫米这样的尺寸呢？

为了保持比例，有 $\frac a b = \frac {\frac b 2} a$, 得 $\frac b a = \sqrt2 = 1.414\cdots$

因此，无论是 $841*1189$， 还是 $210*297$，都是接近 1.414 这个比例的。
...
> 有2男2女，每个人都各自携带不同的性病，而且传染性都很强。如果每个男的和每个女的都发生性关系，但是现在只有2个套套，请问怎样操作才能让每个人都不会感染别人的病？
...
> 现在有n对男女，每个人都各自携带不同的性病，而且传染性都很强。如果每个男的对每个女的都发生性关系，最少需要多少个套套，才能使得他们不感染呢？
...
> 鸡头和凤尾谁强？ 十个人赛跑第一名和一百人赛跑的第十名谁厉害

从(0,1) 区间上随机抽10个样本，其最大值为 a, 再从 (0,1) 区间随机抽100个样本，其中排名第10大的样本为 b 。问在数学期望的意义下， a 与 b 的大小关系


<div align="center">
    <figure align='center'>
        <img src="./img-game/2019-06-23-12-39-47.png" style="width:500px" />
        <figcaption>取自 https://www.zhihu.com/question/329165105/answer/720599939</figcaption>
    </figure>
</div>
...
$$
p _ { k } ( x ) = \frac { n ! } { ( k - 1 ) ! ( n - k ) ! } ( F ( x ) ) ^ { k - 1 } ( 1 - F ( x ) ) ^ { n - k } p ( x )
$$
...
正好是贝塔分布 $B e ( k , n + 1 - k )$ ， 期望为 $\frac k {n+1}$
